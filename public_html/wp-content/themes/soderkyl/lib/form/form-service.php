...
<div class="modal fade" id="form-service-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">Boka service</h4>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			</div>
			<div class="modal-body">
				<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="multipart/form-data" name="form" id="soderkyl-service-form" class="mb-4">
					...
					<div class="form-group">
						<input type="text" name="form_address" id="form-address" class="form-control" placeholder="Serviceadress">
					</div>
					<div class="form-group">
						<input type="text" name="form_product" id="form-product" class="form-control" placeholder="Produkt eller Produktnr/typ.nr">
					</div>
					<div class="form-group">
