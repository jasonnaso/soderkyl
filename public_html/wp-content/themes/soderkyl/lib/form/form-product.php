...
<div class="modal fade" id="form-product-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form method="post" name="form" id="soderkyl-product-form" action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="multipart/form-data">
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel">Kontaka oss om produkt</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				</div>
				<div class="modal-body">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-secondary mx-0" data-dismiss="modal">Avbryt</button>
					<button type="submit" name="form_submit" id="form-submit" class="btn btn-primary form-btn ml-3">Skicka</button>
				</div>
			</form>
		</div>
	</div>
